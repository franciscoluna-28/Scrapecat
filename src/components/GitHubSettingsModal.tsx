...
export function GitHubSettingsModal({ open, onOpenChange }: GitHubSettingsModalProps) {
  const { repositoryType, perPage, sort, direction, setRepositoryType, setPerPage, setSort, setDirection } = useGitHubSettingsStore();
  ...
  const handleCancel = () => {
    // Reset temp values to current store values
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 py-4">
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Select value={tempRepositoryType} onValueChange={(value: any) => setTempRepositoryType(value)}>
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Select value={tempSort} onValueChange={(value: any) => setTempSort(value)}>
              <SelectTrigger className="col-span-3">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Select value={tempDirection} onValueChange={(value: any) => setTempDirection(value)}>
              <SelectTrigger className="col-span-3">
